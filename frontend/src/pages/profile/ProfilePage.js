        ...
        {!isLoading && !isRefetching && user && (
          <>
            ...
            <div className="relative group/cover">
              <img
                src={coverImg || user?.coverImg || "/avatars/cover.png"}
              ...
              <div className="avatar absolute -bottom-16 left-4">
                <div className="w-32 rounded-full relative group/avatar">
                  <img src={profileImg || user?.profileImg || "/avatars/placeholder.png"} />
            ...
            <div className="flex justify-end px-4 mt-5">
              ...
              {!isMyProfile && (
                <button onClick={() => follow(user?._id)} disabled={isPending}>
                  {isPending ? "Processing..." : amIFollowing ? "Unfollow" : "Follow"}
                </button>
              )}
              {(coverImg || profileImg) && (
                <button
