		...
		<div className='max-w-screen-xl mx-auto flex h-screen px-10 bg-black'>
			...
			<div className='flex-1 flex flex-col justify-center items-center text-white'>
				<form className='lg:w-2/3 mx-auto md:mx-20 flex gap-4 flex-col' onSubmit={handleSubmit}>
					...
					<label className='input input-bordered rounded flex items-center gap-2 bg-black text-white border-white'>
						<MdOutlineMail />
						<input
							type='email'
					...
					<div className='flex gap-4 flex-wrap'>
						<label className='input input-bordered rounded flex items-center gap-2 flex-1 bg-black text-white border-white'>
							<FaUser />
							<input
								type='text'
								className='grow bg-black text-white'
